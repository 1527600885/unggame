...
// +----------------------------------------------------------------------
namespace plugins\ceshi\api\controller;

use app\api\BaseController;
use plugins\ceshi\api\model\Ceshi1 as Ceshi1Model;
/**
 * Ceshi1管理
 */
class Ceshi1 extends BaseController
{
    /**
     * 显示资源列表
     * 访问：game.uswindltd.com/api/ceshi/ceshi1/index
     */
    public function index()
    {
        if ($this->request->isPost()) {
            ...
            $count = Ceshi1Model::count();
            $data  = Ceshi1Model::page($page, 10)->select();
    ...
    {
        if ($this->request->isPost()) {
            Ceshi1Model::find(input("post.id"));
