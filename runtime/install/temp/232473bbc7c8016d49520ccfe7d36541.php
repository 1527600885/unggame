<?php /*a:1:{s:65:"/www/wwwroot/game.uswindltd.com/app/install/view/index/index.html";i:1663558378;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<link rel="shortcut icon" href="<?php echo htmlentities($domain); ?>/upload/favicon.ico" />
<link rel="stylesheet" type="text/css" href="<?php echo htmlentities($domain); ?>/admin/css/element.min.css" />
<style type="text/css">
...
<div id="app" v-cloak>
	<div class="content">
		<div class="header">
			<div class="logo">
				<img src="<?php echo htmlentities($domain); ?>/admin/images/logo_site.png" height="36px">
	...
	<el-dialog :visible.sync="dialog" width="80%" :close-on-click-modal="false"><?php echo $licenses; ?></el-dialog>
</div>
<script type="text/javascript" charset="utf-8" src="<?php echo htmlentities($domain); ?>/admin/js/jquery.min.js"></script>
<script type="text/javascript" charset="utf-8" src="<?php echo htmlentities($domain); ?>/admin/js/vue.min.js"></script>
<script type="text/javascript" charset="utf-8" src="<?php echo htmlentities($domain); ?>/admin/js/element.min.js"></script>
<script type="text/javascript" charset="utf-8" src="<?php echo htmlentities($domain); ?>/admin/js/common.js"></script>
...
new Vue({
    ...
    data() {
        return {
        	...
        	active: <?php echo htmlentities($active); ?>,
